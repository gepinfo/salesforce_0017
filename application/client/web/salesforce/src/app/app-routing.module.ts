...
{ path : 'createaccount', loadChildren: () => import('./createaccount/createaccount.module').then(m => m.CreateaccountModule), canActivate: [AuthGuard] } , 
...
{ path : 'updateaccount', loadChildren: () => import('./updateaccount/updateaccount.module').then(m => m.UpdateaccountModule), canActivate: [AuthGuard] } , 
];
